import { errorPayload, handleHandoff, ValidationError } from '../../../src/handoff-api.mjs';
...
export async function POST(request) {
  try {
    const result = await handleHandoff(await request.json(), AbortSignal.timeout(12_000));
